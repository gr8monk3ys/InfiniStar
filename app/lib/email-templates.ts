...
export function getWelcomeEmailTemplate(params: WelcomeEmailParams) {
  ...
  <ul style="${STYLES.list}">
    ...
    <li><strong>Choose your AI model</strong> - Claude 3.5 Sonnet, Haiku, or Opus</li>
  ...
  <p style="${STYLES.muted}">
    You have <strong>10 free messages</strong> per month. Upgrade to PRO for unlimited conversations!
  </p>`)
...
- Choose your AI model - Claude 3.5 Sonnet, Haiku, or Opus
...
You have 10 free messages per month. Upgrade to PRO for unlimited conversations!
