            ...
            <div className="rounded-lg border border-destructive/30 bg-destructive/10 p-6">
              ...
              <div className="mt-4 rounded-md border border-yellow-500/30 bg-yellow-500/10 p-3">
                <p className="text-sm text-yellow-800 dark:text-yellow-200">
                  <strong>30-Day Grace Period:</strong> After requesting deletion, you have 30 days
                  to change your mind. During this time, you can log in and cancel the deletion
                  request.
                </p>
              </div>
              <div className="mt-6">
...
// Export the DeletionStatus type for use by page.tsx tab badge
