    ...
    <section className="container grid items-center gap-6 pb-8 pt-6 md:py-10">
      <div className="flex max-w-[80%] flex-col items-start gap-2">
        ...
        <p className="text-lg text-muted-foreground">
          ...
          protected by our privacy policy.If you are under 13 years old OR if
          you are an EU citizen or resident under 16 years old, you are not
          authorized to register to use the Services. Member Account, Password
          and Security. You are responsible for maintaining the confidentiality
          of your password and account, if any, and are fully responsible for
          any and all activities that occur under your password or account. You
          agree to (a) immediately notify Infinistar of any unauthorized use of
          ...
          applicable law enforcement authorities. You agree to not use the
          Website or Services to: upload or transmit any content that: (i)
          ...
          contractual or other relationships; (iii) contains software viruses or
          ...
          Services, or which may expose Infinistar or its users to any harm or
          liability of any type; interfere with or disrupt the Website or
          Services or servers or networks connected to the Website or Services,
          or disobey any requirements, procedures, policies or regulations of
          networks connected to the Website or Services; violate any applicable
          local, state, national or international law, or any regulations having
          the force of law; impersonate any person or entity, or falsely state
          ...
          permitted to use them for the applicable purposes, for example by
          license or legal exception or limitation. By creating or uploading any
          User Content you own or create using the Service, you retain all
          rights in it (to the extent you would otherwise hold such rights) and
          hereby grant and will grant Infinistar to the fullest extent permitted
          under the law a nonexclusive, worldwide, royalty-free, fully paid up,
          ...
          automated data gathering or extraction methods. If you are blocked by
          Infinistar from accessing the Website or Services (including by
          ...
          proxy IP address). Any use of the Website or Services, or the Site
          Content, other than as specifically authorized herein, is strictly
          prohibited. Any rights not expressly granted herein are reserved by
          Infinistar. Third-Party Material: Under no circumstances will
          Infinistar be liable in any way for any content or materials of any
          third parties, including Joyland bots created by third parties and any
          Generations resulting from such Joyland bots, including, but not
          limited to infringement of intellectual property rights, for any
          ...
          acknowledge that Infinistar does not pre-screen content, but that
          Infinistar and its designees will have the right (but not the
          ...
          limiting the foregoing, you acknowledge and agree that Infinistar may
          preserve content and may also disclose content and/or metadata if
          ...
          before it was removed or disabled; a statement that you have a good
          faith belief that the content was removed or disabled as a result of
          mistake or a misidentification of the content; and your name, address,
          telephone number, and email address, a statement that you consent to
          the jurisdiction of the federal court located within the Northern
          District of California and a statement that you will accept service of
          process from the person who provided notification of the alleged
          infringement. If a counter-notice is received by the Copyright Agent,
          Infinistar will send a copy of the counter-notice to the original
          ...
          receipt of the counter-notice, at our sole discretion. Third Party
          Websites and Services The Services may provide, or third parties may
          provide, links or other access to other sites and resources on the
          Internet or to third-party applications. Infinistar has no control
          over such sites, resources, or applications and Infinistar is not
          responsible for and does not endorse such sites, resources, or
          applications. You further acknowledge and agree that Infinistar will
          ...
          use of or reliance on any content, events, goods, or services
          available on or through any such sites, resources or applications. Any
          dealings you have with third parties found while using the Services
          are between you and the third party, and you agree that Infinistar is
          not liable for any loss or claim that you may have against any such
          third party. Limitation of Liability You expressly understand and
          agree that Infinistar will not be liable for any indirect, incidental,
          ...
          use, data or other intangible losses (even if Infinistar has been
          ...
          from: (I) the use or the inability to use the Services or any related
          ...
          your sole and exclusive remedy is to discontinue the use of the
          ...
          between us, shall be resolved exclusively through final and binding
          ...
          entering into these Terms, you and Infinistar are each waiving the
          ...
          enforcement of this Arbitration Agreement. Prohibition of Class and
          Representative Actions and Non-Individualized Relief You and
          Infinistar agree that each of us may bring claims against the other
          ...
          support@joyland.ai. The email must (i) describe the nature and basis
          of the claim or dispute and (ii) set forth the specific relief sought.
          If Infinistar and you do not resolve the claim within sixty (60)
          calendar days after the Notice is received, you or Infinistar may
          commence an arbitration proceeding. During the arbitration, the amount
          of any settlement offered by Infinistar or you shall not be disclosed
          to the arbitrator until after the arbitrator determines the amount, if
          any, to which you or Infinistar are entitled. Termination You agree
          that Infinistar, in its sole discretion, may suspend or terminate your
          account (or any part thereof) or use of the Services and remove and
          ...
          any provision of these Terms or our AUP may be effected without prior
          notice, and acknowledge and agree that Infinistar may (but has no
          obligation to) immediately deactivate or delete your account and all
          ...
          and govern your use of our Services, superseding any prior agreements
          between you and Infinistar with respect to the Services. Choice of
          Law, Jurisdiction, Venue: These terms are governed by the laws of the
          ...
          set forth above, you and Infinistar agree to submit to the personal
          and exclusive jurisdiction of the state and federal courts located
          ...
          or provision. Expiration of Claims: You agree that regardless of any
