...
export const env = createEnv({
  ...
  server: {
    ...
    CONTENT_SECURITY_POLICY_REPORT_ONLY: z.string().optional(),
    CONTENT_SECURITY_POLICY_REPORT_URI: z.string().optional(),
  ...
  runtimeEnv: {
    ...
    CONTENT_SECURITY_POLICY_REPORT_ONLY: process.env.CONTENT_SECURITY_POLICY_REPORT_ONLY,
    CONTENT_SECURITY_POLICY_REPORT_URI: process.env.CONTENT_SECURITY_POLICY_REPORT_URI,
