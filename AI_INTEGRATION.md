...
- Added sparkle icon (✨) button to create AI conversations
...
| --------------------------- | ---- | ----------------------------------------- | ------------------------------- |
| **Helpful Assistant**       | 🤖   | Balanced, clear, and accurate information | General questions, daily tasks  |
| **Creative Writer**         | ✨   | Imaginative, vivid language, storytelling | Creative writing, brainstorming |
| **Technical Expert**        | 💻   | Precise, detailed technical explanations  | Programming, engineering        |
| **Friendly Companion**      | 😊   | Warm, conversational, empathetic          | Casual chat, emotional support  |
| **Professional Consultant** | 💼   | Formal, business-focused advice           | Workplace, productivity         |
| **Socratic Tutor**          | 🎓   | Guides learning through questions         | Education, critical thinking    |
| **Concise Advisor**         | ⚡   | Brief, to-the-point answers               | Quick answers, busy users       |
| **Custom**                  | 🎨   | User-defined system prompt                | Unique requirements             |
...
**From UI:**
Users click the sparkle (✨) button and select a personality from the modal.
